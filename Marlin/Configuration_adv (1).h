...
//#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (600)    // (seconds) Time without extruder movement to trigger protection
...
#pragma endregion extruder fans
