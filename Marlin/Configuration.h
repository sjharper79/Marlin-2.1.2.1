...
#define STRING_CONFIG_H_AUTHOR "(Stephen Harper, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Steve's Ender-3 Pro 4.2.7"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "06f3ae8d-6396-4157-9651-834cc38d08bc"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  29.07 }
    #define DEFAULT_Ki_LIST {   2.80 }
    #define DEFAULT_Kd_LIST {  75.59 }
  #else
    #define DEFAULT_Kp  29.07
    #define DEFAULT_Ki   2.80
    #define DEFAULT_Kd  75.59
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 106.02
  #define DEFAULT_bedKi 19.21
  #define DEFAULT_bedKd 390.14
